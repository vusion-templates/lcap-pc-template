...
var platformConfig = {
    appConfig: {
        project: 'lq0810',
        domainName: 'lq0810',
        nuimsDomain: 'user.lcap.hatest.163yun.com',
        envNuimsDomain: {
            dev: 'user.lcap.hatest.163yun.com',
            online: 'user.lcap.hatest.163yun.com',
        },
        tenantType: 0,
        tenantLevel: 1,
        extendedConfig: null,
        envConfig: {
            lowcodeDomain: 'lcap.hatest.163yun.com',
        },
    ...
    hasUserCenter: true,
    hasAuth: true,
    authResourcePaths: ['/permission_center/addRoleUser', '/permission_center/resourceManagement', '/permission_center/roleManagement', '/permission_center/userManagement', '/permission_center',],
    baseResourcePaths: ['/login', '/index', '/dashboard', '/noAuth', '/notFound',],
};
var metaData = {
    frontendVariables: [],
    dataTypesMap: {
        ...
        'app.dataSources.defaultDS.entities.LCAPLogicViewMapping': {
            ...
            uuid: '5f06d6db4f724c688397ad423481d0eb',
            tableName: 'LCAPLogicViewMapping_ee5daa',
            description: '记录应用全局逻辑与页面资源的关联关系',
            origin: 'ide',
            properties: [{
                concept: 'EntityProperty',
                name: 'id',
                uuid: '00ca333bdeea4d6caa09c0d296cc0892',
                columnName: 'id',
                label: '主键',
                description: '主键',
                typeAnnotation: {
                ...
                rules: [],
                generationRule: 'auto',
                sequence: 'Entity14946531801',
                isLeaf: true
            }, {
                concept: 'EntityProperty',
                name: 'logicIdentifier',
                uuid: '702c064af3ff42c9aece0671456f593e',
                columnName: 'logicIdentifier',
                label: '逻辑标识',
                description: '/api/logic1:GET',
                typeAnnotation: {
                    concept: 'TypeAnnotation',
                    name: '',
                    typeKind: 'primitive',
                ...
                concept: 'EntityProperty',
                name: 'resourceName',
                uuid: 'c2c5f289ff3d4250b2047e0041a247dd',
                columnName: 'resourceName',
                label: '资源路径',
                description: '/dashboard/button1',
                typeAnnotation: {
                    concept: 'TypeAnnotation',
                    name: '',
                    typeKind: 'primitive',
                ...
                concept: 'EntityProperty',
                name: 'resourceType',
                uuid: 'b5b1e3c970454ff4887a9c5c94ebd34f',
                columnName: 'resourceType',
                label: '资源类型',
                description: '页面-page 组件-component 逻辑-logic',
                typeAnnotation: {
                    concept: 'TypeAnnotation',
                    name: '',
                    typeKind: 'primitive',
                ...
                concept: 'EntityProperty',
                name: 'group',
                uuid: 'ddd0e5d0c7c64c65872e0f4ad78a3a8d',
                columnName: 'group',
                label: '逻辑与资源绑定的分组关系',
                description: '值一样的为同一组',
                typeAnnotation: {
                    concept: 'TypeAnnotation',
                    name: '',
                    typeKind: 'primitive',
                ...
                concept: 'EntityProperty',
                name: 'changeTime',
                uuid: '6791c104dfef42139a31f306da771cdb',
        ...
        'app.dataSources.defaultDS.entities.LCAPUser': {
            concept: 'Entity',
            name: 'LCAPUser',
            uuid: '441e5caf2b704133991eb1829111bdbc',
            tableName: 'LCAPUser_ee5daa',
            description: '制品应用的用户实体。\n1 实体名称不允许改动\n2 默认生成的字段不允许改动\n3 可新增自定义字段（避免设置为非空且无默认值）',
            origin: 'ide',
            properties: [{
                concept: 'EntityProperty',
                name: 'id',
                uuid: '4697e091201d45d592f28881cc223904',
                columnName: 'id',
                label: '主键',
                description: '主键',
                typeAnnotation: {
                ...
                rules: [],
                generationRule: 'auto',
                sequence: 'Entity14476992223',
                isLeaf: true
            }, {
                concept: 'EntityProperty',
                name: 'createdTime',
                uuid: 'fb223319c82f40a78e0c5ee7fa7b21ff',
                ...
                concept: 'EntityProperty',
                name: 'updatedTime',
                uuid: '4ea2a93a29394a6c8bf97423ee32195e',
                ...
                concept: 'EntityProperty',
                name: 'userId',
                uuid: '41f6e2283ecf424f98fd25cf96db235f',
                columnName: 'userId',
                label: '用户id',
                ...
                concept: 'EntityProperty',
                name: 'userName',
                uuid: 'c8aa563bd6cc4aa9b264f7c099ae9908',
                columnName: 'userName',
                label: '用户名',
                ...
                concept: 'EntityProperty',
                name: 'password',
                uuid: '55bb894635bf4a8cb9ef993bcc37d025',
                columnName: 'password',
                label: '登录密码',
                ...
                concept: 'EntityProperty',
                name: 'phone',
                uuid: '1e5b52eb6e9c42f9887f21a3a5e5f492',
                columnName: 'phone',
                label: '手机号',
                description: null,
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'email',
                uuid: '373e7347d93142e89b31cbeb327e2f7e',
                columnName: 'email',
                label: '邮箱',
                description: null,
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'displayName',
                uuid: 'f26cedc755594e46997b27e17d59da02',
                ...
                concept: 'EntityProperty',
                name: 'status',
                uuid: '39db68eb3bb0427a81eb08604da37e0c',
                columnName: 'status',
                label: '状态',
                description: '状态，标识当前用户的状态是什么',
                typeAnnotation: {
                    concept: 'TypeAnnotation',
                    name: '',
                    typeKind: 'reference',
                    typeNamespace: 'app.enums',
                    typeName: 'UserStatusEnum',
                    typeArguments: null,
                    returnType: null,
                    properties: null
                },
                ...
                concept: 'EntityProperty',
                name: 'source',
                uuid: '4b713fa82fce488990d37cd459fa3376',
                columnName: 'source',
                label: '用户来源',
        ...
        'app.dataSources.defaultDS.entities.LCAPRolePerMapping': {
            concept: 'Entity',
            name: 'LCAPRolePerMapping',
            uuid: '9ad3867cb3df4c1bb7a7fde8cd9bd4f6',
            tableName: 'LCAPRolePerMapping_ee5daa',
            description: '角色权限关联实体。新增角色一般需要新增角色对应的权限。默认生成的字段不允许改动，可新增自定义字段。',
            origin: 'ide',
            properties: [{
                concept: 'EntityProperty',
                name: 'id',
                uuid: '7923965fcfdc4c03b1447e028060e880',
                columnName: 'id',
                label: '主键',
                description: '主键',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'createdTime',
                uuid: '328f4ae487c445cab884ed00b35f7da1',
                columnName: 'createdTime',
                label: '创建时间',
                description: '创建时间',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'updatedTime',
                uuid: '37c8bd54ae784f759cc26eac462b1b61',
                columnName: 'updatedTime',
                label: '更新时间',
                description: '更新时间',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'createdBy',
                uuid: '1125b72cd0074cefacd9803026e63880',
                ...
                concept: 'EntityProperty',
                name: 'updatedBy',
                uuid: '457b195a2b484409914807ab284b14fe',
                ...
                concept: 'EntityProperty',
                name: 'roleId',
                uuid: '6610ad53895944ab822c7e9325b9297b',
                columnName: 'roleId',
                label: '角色唯一ID',
                description: '',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'permissionId',
                uuid: '3061b62fda794567bfff9b5d0028eb1d',
        ...
        'app.dataSources.defaultDS.entities.LCAPPerResMapping': {
            concept: 'Entity',
            name: 'LCAPPerResMapping',
            uuid: 'ba727062351640e48f8b0b9cf9682cb8',
            tableName: 'LCAPPerResMapping_ee5daa',
            description: '权限与资源的关联实体。一组权限会包含若干资源路径，权限对应角色。为角色绑定移除资源需操作该表。默认字段不允许改动，可新增字段。',
            origin: 'ide',
            properties: [{
                concept: 'EntityProperty',
                name: 'id',
                uuid: '156ef915693a4c13a1311babc43550cf',
                columnName: 'id',
                label: '主键',
                description: '主键',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'createdTime',
                uuid: '9db23cf2f13c4ed2bea520e64e853a9c',
                columnName: 'createdTime',
                label: '创建时间',
                description: '创建时间',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'updatedTime',
                uuid: 'c09f9bec507045028d28fd2dc3f7ec85',
                columnName: 'updatedTime',
                label: '更新时间',
                description: '更新时间',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'createdBy',
                uuid: '03366e7877cf4d169f24561f11f3a45c',
                columnName: 'createdBy',
                label: '创建者',
                description: '创建者',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'updatedBy',
                uuid: '846cd19bc8844441bc2ea7a0a4097b7a',
                columnName: 'updatedBy',
                label: '更新者',
                description: '更新者',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'permissionId',
                uuid: '00e6881dbca145b19ffc8c78ccbe442a',
                columnName: 'permissionId',
                label: '权限唯一ID',
                description: '',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'resourceId',
                uuid: '60f14e92734f494fb4ade2c1cf08b9e3',
        ...
        'app.dataSources.defaultDS.entities.LCAPUserRoleMapping': {
            concept: 'Entity',
            name: 'LCAPUserRoleMapping',
            uuid: '33181480b01e44e8b0c428f2724d854e',
            tableName: 'LCAPUserRoleMapping_ee5daa',
            description: '用户与角色关联实体。操作该表可完成为角色添加成员、移除角色成员等。默认生成的字段不允许改动，可新增自定义字段。',
            origin: 'ide',
            properties: [{
                concept: 'EntityProperty',
                name: 'id',
                uuid: '2e62b535fd7647b6a18ebe17ade4846f',
                columnName: 'id',
                label: '主键',
                description: '主键',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'createdTime',
                uuid: '022b13dd44434ee4b634ce3b2f8ab49f',
                columnName: 'createdTime',
                label: '创建时间',
                description: '创建时间',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'updatedTime',
                uuid: 'e1cd6672b42f462090c0507898b6cce3',
                columnName: 'updatedTime',
                label: '更新时间',
                description: '更新时间',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'createdBy',
                uuid: 'f77c8a18eca143f7acdaa00acb6d1fd6',
                columnName: 'createdBy',
                label: '创建者',
                description: '创建者',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'updatedBy',
                uuid: 'da9c39011e6342a1a04498d278658ac5',
                columnName: 'updatedBy',
                label: '更新者',
                description: '更新者',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'userId',
                uuid: '4bb3ff8f66c94a4d91c48f44d1735c06',
                columnName: 'userId',
                label: '用户唯一ID',
                description: '',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'roleId',
                uuid: 'a41321636c4d43688471beb5f6c3b4aa',
                columnName: 'roleId',
                label: '角色唯一ID',
                description: '',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'userName',
                uuid: 'eb7de42683c44f64842937de161994b2',
                columnName: 'userName',
                label: '用户名',
                description: '',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'source',
                uuid: '3b22311184824c2cb22a4bf55c3fdabf',
                columnName: 'source',
                label: '用户来源',
                description: '',
                typeAnnotation: {
        ...
        'app.dataSources.defaultDS.entities.LCAPRole': {
            concept: 'Entity',
            name: 'LCAPRole',
            uuid: '0dd7862f392649e9a56bf3f693488fcb',
            tableName: 'LCAPRole_ee5daa',
            description: '用户与角色关联实体。操作该表可完成为角色添加成员、移除角色成员等。默认生成的字段不允许改动，可新增自定义字段。',
            origin: 'ide',
            properties: [{
                concept: 'EntityProperty',
                name: 'id',
                uuid: 'a3a773373a8f4bdbb5fbfeac6ffc220d',
                columnName: 'id',
                label: '主键',
                description: '主键',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'createdTime',
                uuid: '9cecfb2f32054e0e870cb779e44c47ff',
                columnName: 'createdTime',
                label: '创建时间',
                description: '创建时间',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'updatedTime',
                uuid: '40b7d16a93db4dc593cba3f74c446747',
                columnName: 'updatedTime',
                label: '更新时间',
                description: '更新时间',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'createdBy',
                uuid: 'c5badf10eeec4520a1e39acfc702542f',
                columnName: 'createdBy',
                label: '创建者',
                description: '创建者',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'updatedBy',
                uuid: '9830754687b34e8da7bbc74fa5800089',
                columnName: 'updatedBy',
                label: '更新者',
                description: '更新者',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'uuid',
                uuid: '913a4c94dc51447a8a27f0f81d4d3aa8',
                columnName: 'uuid',
                label: '唯一标识',
                description: '唯一标识',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'name',
                uuid: '77d435f04da6465ca03e93907192ebb9',
                columnName: 'name',
                label: '角色名称',
                description: '角色名',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'description',
                uuid: '2c1920ed95e74abfbaacb160325d2e8e',
                ...
                concept: 'EntityProperty',
                name: 'roleStatus',
                uuid: '3eabcf426a0b43af87cc52073846dc98',
                columnName: 'roleStatus',
                label: '角色状态',
                description: '角色状态，可配置true启用，false禁用。',
                typeAnnotation: {
                    concept: 'TypeAnnotation',
                    name: '',
                    typeKind: 'primitive',
                ...
                concept: 'EntityProperty',
                name: 'editable',
                uuid: 'a50398f5944f46c1b87defd952185794',
                columnName: 'editable',
                label: '是否可编辑',
                description: '系统字段，请勿修改。web新增为可编辑true，ide新增为不可编辑false。',
                typeAnnotation: {
                    concept: 'TypeAnnotation',
                    name: '',
                    typeKind: 'primitive',
        ...
        'app.dataSources.defaultDS.entities.LCAPPermission': {
            concept: 'Entity',
            name: 'LCAPPermission',
            uuid: '6664be2d47de48579b46397fa404953d',
            tableName: 'LCAPPermission_ee5daa',
            description: '权限实体。新增角色的同时要一般需要绑定角色对应的权限。默认生成的字段不允许改动，可新增自定义字段。',
            origin: 'ide',
            properties: [{
                concept: 'EntityProperty',
                name: 'id',
                uuid: '859584a4eb4a40c1892ba48b693b9364',
                columnName: 'id',
                label: '主键',
                description: '主键',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'createdTime',
                uuid: '7049c4f9f65743dba5a22357fd476eb4',
                columnName: 'createdTime',
                label: '创建时间',
                description: '创建时间',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'updatedTime',
                uuid: '3091ef769cb44e2bb38fc515a5e586f2',
                columnName: 'updatedTime',
                label: '更新时间',
                description: '更新时间',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'createdBy',
                uuid: 'f86bee1364044a14a2d66319c07b1772',
                columnName: 'createdBy',
                label: '创建者',
                description: '创建者',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'updatedBy',
                uuid: '2b821616fedc40b29dd42ece8d8787eb',
                columnName: 'updatedBy',
                label: '更新者',
                description: '更新者',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'uuid',
                uuid: '7d73291c1f3e48d8be65424f90eb8282',
                columnName: 'uuid',
                label: '唯一标识',
                description: '唯一标识',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'name',
                uuid: '7ddf5b1c7e704857ae4e63a8b490b64f',
                columnName: 'name',
                label: '权限名称',
                description: '',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'description',
                uuid: 'd988e78ea21b4254b353ad41c7588311',
                columnName: 'description',
                label: '权限描述',
                description: '',
                typeAnnotation: {
        ...
        'app.dataSources.defaultDS.entities.LCAPResource': {
            concept: 'Entity',
            name: 'LCAPResource',
            uuid: '033066dc63de47f4b91ef12181869457',
            tableName: 'LCAPResource_ee5daa',
            description: '资源实体。该表的数据是新建组件后，系统自动上报的。name字段对应资源路径。默认生成的字段不允许改动，可新增自定义字段。',
            origin: 'ide',
            properties: [{
                concept: 'EntityProperty',
                name: 'id',
                uuid: 'baca4a40df3f4a08a0a31e2c24eb6772',
                columnName: 'id',
                label: '主键',
                description: '主键',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'createdTime',
                uuid: '980cf6cedf4b410b83c6dacaf29cdd67',
                columnName: 'createdTime',
                label: '创建时间',
                description: '创建时间',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'updatedTime',
                uuid: '1ae63d47a7c64f7aa301cd326fc6ab4e',
                columnName: 'updatedTime',
                label: '更新时间',
                description: '更新时间',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'createdBy',
                uuid: 'c46f80432ed94b8e82b37f0162d0dbd1',
                columnName: 'createdBy',
                label: '创建者',
                description: '创建者',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'updatedBy',
                uuid: '8130917b1d3845468fafbe6febfc19f3',
                columnName: 'updatedBy',
                label: '更新者',
                description: '更新者',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'uuid',
                uuid: 'c908780730b84bab8674bdd8a10ae2f6',
                columnName: 'uuid',
                label: '唯一标识',
                description: '唯一标识',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'name',
                uuid: '05d08f632e604354ab37de0ec468b66c',
                columnName: 'name',
                label: '资源名称',
                ...
                concept: 'EntityProperty',
                name: 'description',
                uuid: '11129257ed8944549e4d98e23a977aeb',
                columnName: 'description',
                label: '资源描述',
                description: '',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'type',
                uuid: 'c93d12feb78e4924a42545b387069069',
                columnName: 'type',
                label: '资源类型',
                description: '',
                typeAnnotation: {
                ...
                concept: 'EntityProperty',
                name: 'clientType',
                uuid: 'cb90ece32b23445aa0cbbdd81fa4d338',
        ...
        getUsersListFromNumis: {
            ...
            name: '',
            typeKind: 'reference',
            typeName: 'getUsersListFromNumis',
            typeArguments: null,
            returnType: null,
            properties: null
        },
    ...
    logicsMap: {
        'app.dataSources.defaultDS.entities.LCAPLogicViewMapping.logics.get': {
            ...
            url: {
                method: 'GET',
                path: '/api/l-c-a-p-logic-view-mapping'
            }
        },
        ...
        'app.dataSources.defaultDS.entities.LCAPLogicViewMapping.logics.updateBy': {
            ...
            url: {
                method: 'PUT',
                path: '/api/l-c-a-p-logic-view-mapping/by'
            }
        },
        ...
        'app.dataSources.defaultDS.entities.LCAPLogicViewMapping.logics.batchCreate': {
            ...
            url: {
                method: 'POST',
                path: '/api/l-c-a-p-logic-view-mapping/batch'
            }
        },
        ...
        'app.dataSources.defaultDS.entities.LCAPLogicViewMapping.logics.import': {
            ...
            url: {
                method: 'POST',
                path: '/api/l-c-a-p-logic-view-mapping/import'
            }
        },
        ...
        'app.dataSources.defaultDS.entities.LCAPRolePerMapping.logics.get': {
            ...
            url: {
                method: 'GET',
                path: '/api/l-c-a-p-role-per-mapping'
            }
        },
        ...
        'app.dataSources.defaultDS.entities.LCAPRolePerMapping.logics.updateBy': {
            ...
            url: {
                method: 'PUT',
                path: '/api/l-c-a-p-role-per-mapping/by'
            }
        },
        ...
        'app.dataSources.defaultDS.entities.LCAPRolePerMapping.logics.batchCreate': {
            ...
            url: {
                method: 'POST',
                path: '/api/l-c-a-p-role-per-mapping/batch'
            }
        },
        ...
        'app.dataSources.defaultDS.entities.LCAPRolePerMapping.logics.import': {
            ...
            url: {
                method: 'POST',
                path: '/api/l-c-a-p-role-per-mapping/import'
            }
        },
        'app.dataSources.defaultDS.entities.LCAPPerResMapping.logics.get': {
            ...
            url: {
                method: 'GET',
                path: '/api/l-c-a-p-per-res-mapping'
            }
        },
        ...
        'app.dataSources.defaultDS.entities.LCAPPerResMapping.logics.updateBy': {
            ...
            url: {
                method: 'PUT',
                path: '/api/l-c-a-p-per-res-mapping/by'
            }
        },
        ...
        'app.dataSources.defaultDS.entities.LCAPPerResMapping.logics.batchCreate': {
            ...
            url: {
                method: 'POST',
                path: '/api/l-c-a-p-per-res-mapping/batch'
            }
        },
        ...
        'app.dataSources.defaultDS.entities.LCAPPerResMapping.logics.import': {
            ...
            url: {
                method: 'POST',
                path: '/api/l-c-a-p-per-res-mapping/import'
            }
        },
        'app.dataSources.defaultDS.entities.LCAPUserRoleMapping.logics.get': {
            ...
            url: {
                method: 'GET',
                path: '/api/l-c-a-p-user-role-mapping'
            }
        },
        ...
        'app.dataSources.defaultDS.entities.LCAPUserRoleMapping.logics.updateBy': {
            ...
            url: {
                method: 'PUT',
                path: '/api/l-c-a-p-user-role-mapping/by'
            }
        },
        ...
        'app.dataSources.defaultDS.entities.LCAPUserRoleMapping.logics.batchCreate': {
            ...
            url: {
                method: 'POST',
                path: '/api/l-c-a-p-user-role-mapping/batch'
            }
        },
        ...
        'app.dataSources.defaultDS.entities.LCAPUserRoleMapping.logics.import': {
            ...
            url: {
                method: 'POST',
                path: '/api/l-c-a-p-user-role-mapping/import'
            }
        },
        ...
        'app.dataSources.defaultDS.entities.LCAPRole.logics.createOrUpdate': {
            ...
            url: {
                method: 'POST',
                path: '/api/l-c-a-p-role/createOrUpdate'
            }
        },
        ...
        'app.dataSources.defaultDS.entities.LCAPPermission.logics.createOrUpdate': {
            ...
            url: {
                method: 'POST',
                path: '/api/l-c-a-p-permission/createOrUpdate'
            }
        },
        'app.dataSources.defaultDS.entities.LCAPPermission.logics.updateBy': {
            ...
            url: {
                method: 'PUT',
                path: '/api/l-c-a-p-permission/by'
            }
        },
        ...
        'app.dataSources.defaultDS.entities.LCAPPermission.logics.batchCreate': {
            ...
            url: {
                method: 'POST',
                path: '/api/l-c-a-p-permission/batch'
            }
        },
        ...
        'app.dataSources.defaultDS.entities.LCAPPermission.logics.import': {
            ...
            url: {
                method: 'POST',
                path: '/api/l-c-a-p-permission/import'
            }
        },
        ...
        'app.dataSources.defaultDS.entities.LCAPResource.logics.createOrUpdate': {
            ...
            url: {
                method: 'POST',
                path: '/api/l-c-a-p-resource/createOrUpdate'
            }
        },
        ...
        'app.dataSources.defaultDS.entities.LCAPResource.logics.batchCreate': {
            ...
            url: {
                method: 'POST',
                path: '/api/l-c-a-p-resource/batch'
            }
        },
        ...
        'app.dataSources.defaultDS.entities.LCAPResource.logics.import': {
            ...
            url: {
                method: 'POST',
                path: '/api/l-c-a-p-resource/import'
            }
        },
        'app.logics.LCAPGetUserList': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPGetUserList'
            }
        },
        'app.logics.LCAPGetUserByUserId': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPGetUserByUserId'
            }
        },
        'app.logics.LCAPGetAllUsers': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPGetAllUsers'
            }
        },
        'app.logics.LCAPGetUserTableView': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPGetUserTableView'
            }
        },
        'app.logics.LCAPRoleBindUsers': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPRoleBindUsers'
            }
        },
        'app.logics.LCAPLoadPermissionManagementTableView': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPLoadPermissionManagementTableView'
            }
        },
        'app.logics.LCAPIsExistRoleId': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPIsExistRoleId'
            }
        },
        'app.logics.LCAPLoadPermissionResourceListView': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPLoadPermissionResourceListView'
            }
        },
        'app.logics.LCAPGetMappingByPermissionIdAndResourceId': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPGetMappingByPermissionIdAndResourceId'
            }
        },
        'app.logics.LCAPGetScopeResourceByRoleId': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPGetScopeResourceByRoleId'
            }
        },
        'app.logics.loadAddRoleUserTableView': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/loadAddRoleUserTableView'
            }
        },
        'app.logics.LCAPGetRoleBindUserList': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPGetRoleBindUserList'
            }
        },
        'app.logics.LCAPLoadRoleManagementTableView': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPLoadRoleManagementTableView'
            }
        },
        'app.logics.LCAPUnBindUsers': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPUnBindUsers'
            }
        },
        'app.logics.LCAPLoadUserRoleMappingTableView': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPLoadUserRoleMappingTableView'
            }
        },
        'app.logics.LCAPGetRolePermissionList': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPGetRolePermissionList'
            }
        },
        'app.logics.LCAPLoadAddRoleUserSelectLCAPRole': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPLoadAddRoleUserSelectLCAPRole'
            }
        },
        'app.logics.LCAPGetUserResources': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPGetUserResources'
            }
        },
        'app.logics.LCAPGetPermissionByRoleId': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPGetPermissionByRoleId'
            }
        },
        'app.logics.LCAPGetResourceListByRoleId': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPGetResourceListByRoleId'
            }
        },
        'app.logics.LCAPGetMappingIdByRoleIdAndUserId': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPGetMappingIdByRoleIdAndUserId'
            }
        },
        'app.logics.LCAPIsAlreadBindUserIdList': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPIsAlreadBindUserIdList'
            }
        },
        'app.logics.LCAPLoadResourceTableView': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPLoadResourceTableView'
            }
        },
        'app.logics.LCAPIsRoleNameRepeated': {
            ...
            url: {
                method: 'POST',
                path: '/api/lcplogics/LCAPIsRoleNameRepeated'
            }
        }
    },
    servicesMap: {
            ...
            const mixin = {
                ...
                methods: {
                    logout() {
                        ...
                        this.$confirm('确定退出登录吗？', '提示').then(() => this.$auth.logout()).then(() => {
                            this.eraseCookie();
                            location.reload();
                        }
                        );
                    ...
                    methods: {
                        ...
                        async submit() {
                            ...
                            if ((validateResult || {}).valid) {
                                if (this.$utils['Convert']((this.input || {}).id, {
                                    "concept": "TypeAnnotation",
                                    "name": "",
                                    "typeKind": "primitive",
                                    "typeNamespace": "nasl.core",
                            ...
                            await (async () => {
                                ...
                                if (Array.isArray(this.userIdListBySelect)) {
                                    for (let i = 0; i < ((this.userIdListBySelect || {}).length); i++) {
                                        ...
                                        if ((isDuplicateUserId) == (true)) { } else {
            ...
            <u-table-view-column ref="uTableViewColumn2">
                <template #cell="current" ref="template4">
                    <u-linear-layout ref="uLinearLayout4" gap="small">
                        <u-text ref="uText2" :text="\$utils['ToString']((((current || {}).item || {}).lCAPUserRoleMapping || {}).userName, 'nasl.core.String')"></u-text>
                    </u-linear-layout>
                </template>
                ...
                return {
                    ...
                    methods: {
                        ...
                        async remove(current) {
                            current = this.$genInitFromSchema('nasl.ui.Current<{lCAPResource: app.dataSources.defaultDS.entities.LCAPResource}>', current !== undefined ? current : (this.$route.query.hasOwnProperty('current') ? this.$genInitFromSchema('nasl.ui.Current<{lCAPResource: app.dataSources.defaultDS.entities.LCAPResource}>', this.$route.query.current) : ""));
                                    ...
                                    for (let i = 0; i < ((permissionList || {}).length); i++) {
                                        ...
                                        if (Array.isArray(this.alreadySelectedResourceIdList)) {
                                            for (let j = 0; j < ((this.alreadySelectedResourceIdList || {}).length); j++) {
                                                ...
                                                if (((mappingIdList || {}).length) > (0)) { } else {
    ...
    <u-table-view ref="tableView" :data-source="loadResourceByRoleId" :show-sizer="true" values="" value-field="lCAPResource.id" :remote-paging="false"
        ...
        <u-table-view-column ref="uTableViewColumn2" type="normal">
            <template #cell="current" ref="template7">
                <u-linear-layout ref="uLinearLayout5" gap="small">
                    <u-text ref="uText4" :text="\$utils['ToString'](((current || {}).item || {}).name, 'nasl.core.String')"></u-text>
                </u-linear-layout>
            </template>
        ...
        <u-table-view-column ref="uTableViewColumn3">
            <template #cell="current" ref="template8">
                <u-linear-layout ref="uLinearLayout6" gap="small">
                    <u-text ref="uText5" :text="\$utils['ToString'](((current || {}).item || {}).description, 'nasl.core.String')"></u-text>
                </u-linear-layout>
            </template>
                    ...
                    <u-table-view-column ref="uTableViewColumn6">
                        <template #cell="current" ref="template10">
                            <u-linear-layout ref="uLinearLayout8" gap="small">
                                <u-text ref="uText6" :text="\$utils['ToString']((((current || {}).item || {}).lCAPResource || {}).name, 'nasl.core.String')"></u-text>
                            </u-linear-layout>
                        </template>
                    ...
                    <u-table-view-column ref="uTableViewColumn7">
                        <template #cell="current" ref="template11">
                            <u-linear-layout ref="uLinearLayout9" gap="small">
                                <u-text ref="uText7" :text="\$utils['ToString']((((current || {}).item || {}).lCAPResource || {}).description, 'nasl.core.String')"></u-text>
                            </u-linear-layout>
                        </template>
                ...
                return {
                    ...
                    methods: {
                        async submit() {
                            ...
                            if ((validateResult || {}).valid) {
                                if (this.$utils['Convert']((this.inputRoleBody || {}).id, {
                                    "concept": "TypeAnnotation",
                                    "name": "",
                                    "typeKind": "primitive",
                                    "typeNamespace": "nasl.core",
                        ...
                        async modify(current) {
                            current = this.$genInitFromSchema('nasl.ui.Current<{lCAPRole: app.dataSources.defaultDS.entities.LCAPRole}>', current !== undefined ? current : (this.$route.query.hasOwnProperty('current') ? this.$genInitFromSchema('nasl.ui.Current<{lCAPRole: app.dataSources.defaultDS.entities.LCAPRole}>', this.$route.query.current) : ""));
            ...
            <u-table-view-column ref="uTableViewColumn2" :width="300">
                <template #cell="current" ref="template13">
                    <u-linear-layout ref="uLinearLayout12" gap="small">
                        <u-text ref="uText8" :text="\$utils['ToString']((((current || {}).item || {}).lCAPRole || {}).name, 'nasl.core.String')"></u-text>
                    </u-linear-layout>
                </template>
                <template #title ref="template18">
            ...
            <u-table-view-column ref="uTableViewColumn3" :width="300">
                <template #cell="current" ref="template14">
                    <u-linear-layout ref="uLinearLayout13" gap="small" v-if="((((current || {}).item || {}).lCAPRole || {}).editable) == (true)">
                        <u-text ref="uText9" :text="\$utils['ToString']((((current || {}).item || {}).lCAPRole || {}).description, 'nasl.core.String')"></u-text>
                    </u-linear-layout>
                </template>
                <template #title ref="template19">
                    ...
                    <u-table-view-column ref="uTableViewColumn6">
                        <template #cell="current" ref="template16">
                            <u-linear-layout ref="uLinearLayout15" gap="small">
                                <u-text ref="uText10" :text="\$utils['ToString'](((current || {}).item || {}).name, 'nasl.core.String')"></u-text>
                            </u-linear-layout>
                        </template>
                        ...
                        async submit() {
                            ...
                            if ((validateResult || {}).valid) {
                                if ((this.isUpdate) == (true)) {
                                    ...
                                    this.input.password = await (this.$global.encryptByAES({
            ...
            <u-table-view-column ref="table_view_column2" field="lCAPUser.userName">
                <template #cell="current" ref="template1">
                    <u-linear-layout ref="linear_layout3" gap="small">
                        <u-text ref="text1" :text="\$utils['ToString']((((current || {}).item || {}).lCAPUser || {}).userName, 'nasl.core.String')"></u-text>
                    </u-linear-layout>
                </template>
                <template #title ref="template16">
            ...
            <u-table-view-column ref="table_view_column3" field="lCAPUser.phone">
                <template #cell="current" ref="template2">
                    <u-linear-layout ref="linear_layout4" gap="small">
                        <u-text ref="text2" :text="\$utils['ToString']((((current || {}).item || {}).lCAPUser || {}).phone, 'nasl.core.String')"></u-text>
                    </u-linear-layout>
                </template>
                <template #title ref="template17">
            ...
            <u-table-view-column ref="table_view_column4" field="lCAPUser.email">
                <template #cell="current" ref="template3">
                    <u-linear-layout ref="linear_layout5" gap="small">
                        <u-text ref="text3" :text="\$utils['ToString']((((current || {}).item || {}).lCAPUser || {}).email, 'nasl.core.String')"></u-text>
                    </u-linear-layout>
                </template>
                <template #title ref="template18">
            ...
            <u-table-view-column ref="table_view_column5" field="lCAPUser.displayName">
                <template #cell="current" ref="template4">
                    <u-linear-layout ref="linear_layout6" gap="small">
                        <u-text ref="text4" :text="\$utils['ToString']((((current || {}).item || {}).lCAPUser || {}).displayName, 'nasl.core.String')"></u-text>
                    </u-linear-layout>
                </template>
                <template #title ref="template19">
