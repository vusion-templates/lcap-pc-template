...
methods: {
    ...
    <u-calendar-table :ref="\`calendar_table1\`"></u-calendar-table>
</u-linear-layout>
`,
                });
...
return {
        ...
        data() {
            return {
                ['entity1']:this.$genInitFromSchema('app.dataSources.defaultDS.entities.Entity1', undefined),
['input']:this.$genInitFromSchema('app.dataSources.defaultDS.entities.Entity1', undefined),
['filter']:this.$genInitFromSchema('app.dataSources.defaultDS.entities.Entity1', undefined),
['isUpdate']:undefined
            };
        },
meta: {
...
methods: {
    async load (params) {
        ...
        let result =this.$genInitFromSchema('{list: nasl.collection.List<{entity1: app.dataSources.defaultDS.entities.Entity1}>, total: nasl.core.Long}',undefined);

result = this.$genInitFromSchema('{list: nasl.collection.List<{entity1: app.dataSources.defaultDS.entities.Entity1}>, total: nasl.core.Long}', await (this.$logics['app.logics.loadAaaTableView']({
                config: {
                    download: false,
                },
                query: {},
                headers: {
                    "lcap-calllogic-uuid": "8c0e5d3799d34b6aa9bf1da9a5960cd1",
                },
            path: {},
                body: {
page: (params || {}).page, 
...
async aaa_created (event) { 
await (async () => {

this.$genInitFromSchema('app.dataSources.defaultDS.entities.Entity1', this.$utils['Clear'](this.filter))
return;
    })();
}
,
...
await (console.log(this.$utils['ToString'](this.$utils['ToString'](`111`, 'nasl.core.String'), 'nasl.core.String')))
return;
    })();
}
,
...
this.isUpdate = false
this.input = this.$genInitFromSchema('app.dataSources.defaultDS.entities.Entity1', this.$utils['Clone'](this.entity1))
...
this.$genInitFromSchema('app.dataSources.defaultDS.entities.Entity1', await (this.$logics['app.dataSources.defaultDS.entities.Entity1.logics.update']({
                config: {
                    download: false,
                },
                query: {},
                headers: {
                    "lcap-calllogic-uuid": "75d84d4ea8d4413d84b0d058aebbb09c",
                },
            body: {
entity: this.input},
...
validateResult = await (this.$refs && this.$refs[`saveModalForm`] && this.$refs[`saveModalForm`].validate && this.$refs[`saveModalForm`].validate())
if ((validateResult || {}).valid) {
this.$genInitFromSchema('app.dataSources.defaultDS.entities.Entity1', await (this.$logics['app.dataSources.defaultDS.entities.Entity1.logics.create']({
                config: {
                    download: false,
                },
                query: {},
                headers: {
                    "lcap-calllogic-uuid": "d47d2e3d02884bc3a95285eedf6034a1",
                },
...
this.isUpdate = true
this.input = this.$genInitFromSchema('app.dataSources.defaultDS.entities.Entity1', this.$utils['Clone'](((current || {}).item || {}).entity1))
await (this.$refs && this.$refs[`saveModal`] && this.$refs[`saveModal`].open && this.$refs[`saveModal`].open())
return;
    })();
}
...
await (this.$logics['app.dataSources.defaultDS.entities.Entity1.logics.delete']({
                config: {
                    download: false,
                },
                query: {},
                headers: {
                    "lcap-calllogic-uuid": "32c94ba84f8b4b2c91d0035e8d06dc00",
                },
            query: {
id: (((current || {}).item || {}).entity1 || {}).id},
body: {}
}))
await (this.$refs && this.$refs[`tableView`] && this.$refs[`tableView`].reload && this.$refs[`tableView`].reload())
return;
            ...
            <u-form :ref="\`form1\`" layout="inline" key="form1">
                <u-form-item :ref="\`form_item1\`" layout="center">
                    <template #label :ref="\`template1\`">
                        <u-text :ref="\`text1\`" text="property1"></u-text>
                    </template>
                    <u-select :ref="\`select1\`" clearable="" placeholder="请选择property1"
                        :data-source="\$utils['EnumToList']({'concept':'TypeAnnotation','name':'','typeKind':'reference','typeNamespace':'app.enums','typeName':'UserStatusEnum','typeArguments':null,'returnType':null,'properties':null})"
                        :value.sync="filter.property1" key="select1"></u-select>
                </u-form-item>
                <u-form-item :ref="\`form_item2\`" layout="center" label-size="auto">
                    <u-button :ref="\`button2\`" color="primary" text="查 询" @click="button2_click(\$event)"></u-button>
                </u-form-item>
            </u-form>
            <u-linear-layout :ref="\`linear_layout3\`">
                <u-button :ref="\`button3\`" color="primary" text="创 建" @click="button3_click(\$event)"></u-button>
            </u-linear-layout>
        </u-linear-layout>
        <u-table-view :ref="\`tableView\`" :data-source="load" data-schema="LoadAaaTableViewStructure" value-field="entity1.id" :pagination="true" :show-sizer="true"
            key="tableView">
            <u-table-view-column :ref="\`table_view_column1\`" type="index" width="60">
                <template #cell="current" :ref="\`template2\`"></template>
                <template #title :ref="\`template3\`">
                    <u-text :ref="\`text2\`" text="序号"></u-text>
                </template>
            </u-table-view-column>
            <u-table-view-column :ref="\`table_view_column2\`" field="entity1.createdTime">
                <template #cell="current" :ref="\`template4\`">
                    <u-linear-layout :ref="\`linear_layout4_\${(current || {}).__nodeKey || (current || {}).index}\`" gap="small">
                        <u-text :ref="\`text3_\${(current || {}).__nodeKey || (current || {}).index}\`" :text="\$utils['ToString']((((current || {}).item || {}).entity1 || {}).createdTime, 'nasl.core.DateTime')"></u-text>
                    </u-linear-layout>
                </template>
                <template #title :ref="\`template5\`">
                    <u-text :ref="\`text4\`" text="创建时间"></u-text>
                </template>
            </u-table-view-column>
            <u-table-view-column :ref="\`table_view_column3\`" field="entity1.updatedTime">
                <template #cell="current" :ref="\`template6\`">
                    <u-linear-layout :ref="\`linear_layout5_\${(current || {}).__nodeKey || (current || {}).index}\`" gap="small">
                        <u-text :ref="\`text5_\${(current || {}).__nodeKey || (current || {}).index}\`" :text="\$utils['ToString']((((current || {}).item || {}).entity1 || {}).updatedTime, 'nasl.core.DateTime')"></u-text>
                    </u-linear-layout>
                </template>
                <template #title :ref="\`template7\`">
                    <u-text :ref="\`text6\`" text="更新时间"></u-text>
                </template>
            </u-table-view-column>
            <u-table-view-column :ref="\`table_view_column4\`" field="entity1.property1">
                <template #cell="current" :ref="\`template8\`">
                    <u-linear-layout :ref="\`linear_layout6_\${(current || {}).__nodeKey || (current || {}).index}\`" gap="small">
                        <u-text :ref="\`text7_\${(current || {}).__nodeKey || (current || {}).index}\`" :text="\$utils['ToString']((((current || {}).item || {}).entity1 || {}).property1, 'app.enums.UserStatusEnum')"></u-text>
                    </u-linear-layout>
                </template>
                <template #title :ref="\`template9\`">
                    <u-text :ref="\`text8\`" text="property1"></u-text>
                </template>
            </u-table-view-column>
            <u-table-view-column :ref="\`table_view_column5\`" title="操作">
                <template #cell="current" :ref="\`template10\`">
                    <u-linear-layout :ref="\`linear_layout7_\${(current || {}).__nodeKey || (current || {}).index}\`" gap="small">
                        ...
                        <u-link :ref="\`link2_\${(current || {}).__nodeKey || (current || {}).index}\`" text="删除" @click="link2_click(\$event, current)"></u-link>
                    </u-linear-layout>
                </template>
                <template #title :ref="\`template11\`">
                    <u-text :ref="\`text9\`" text="操作"></u-text>
                </template>
            </u-table-view-column>
        </u-table-view>
        <u-modal :ref="\`saveModal\`">
            <template #foot :ref="\`template12\`">
                <u-linear-layout :ref="\`linear_layout8\`">
                    <u-button :ref="\`button4\`" color="primary" text="提交修改" @click="button4_click(\$event)" v-if="isUpdate"></u-button>
                    <u-button :ref="\`button5\`" color="primary" text="立即创建" @click="button5_click(\$event)" v-if="!(isUpdate)"></u-button>
                </u-linear-layout>
            </template>
            <template #body :ref="\`template13\`">
                <u-form :ref="\`saveModalForm\`" key="saveModalForm">
                    <u-form-item :ref="\`form_item3\`" layout="center">
                        <template #label :ref="\`template14\`">
                            <u-text :ref="\`text10\`" text="property1"></u-text>
                        </template>
                        <u-select :ref="\`select2\`" clearable="" placeholder="请选择property1"
                            :data-source="\$utils['EnumToList']({'concept':'TypeAnnotation','name':'','typeKind':'reference','typeNamespace':'app.enums','typeName':'UserStatusEnum','typeArguments':null,'returnType':null,'properties':null})"
                            :value.sync="input.property1" key="select2"></u-select>
                    </u-form-item>
                </u-form>
            </template>
            <template #title :ref="\`template15\`">
                <div :ref="\`div1\`" v-if="isUpdate">
                    <u-text :ref="\`text11\`" text="修改"></u-text>
                </div>
                <div :ref="\`div2\`" v-if="!(isUpdate)">
                    <u-text :ref="\`text12\`" text="创建"></u-text>
                </div>
            </template>
        </u-modal>
    </u-linear-layout>
    <u-text :ref="\`text13\`" :text="\$utils['ToString']((entity1 || {}).property1, 'app.enums.UserStatusEnum')"></u-text>
</u-linear-layout>
`,
                });
                return componentOptions;
...
var $forEachListVariable6631 = this.alreadyBindRoleUserList;
var $forEachStartVariable6631 = 0;
var $forEachEndVariable6631 = (this.alreadyBindRoleUserList || {}).length;
if(Array.isArray($forEachListVariable6631)) {
for (let i = $forEachStartVariable6631; i < $forEachEndVariable6631; i++) {
const item = $forEachListVariable6631[i];
...
var $forEachListVariable9842 = this.userIdListBySelect;
var $forEachStartVariable9842 = 0;
var $forEachEndVariable9842 = (this.userIdListBySelect || {}).length;
if(Array.isArray($forEachListVariable9842)) {
for (let i = $forEachStartVariable9842; i < $forEachEndVariable9842; i++) {
const item = $forEachListVariable9842[i];
...
var $forEachListVariable1680 = (variable2 || {}).list;
var $forEachStartVariable1680 = 0;
var $forEachEndVariable1680 = ((variable2 || {}).list || {}).length;
if(Array.isArray($forEachListVariable1680)) {
for (let i = $forEachStartVariable1680; i < $forEachEndVariable1680; i++) {
const item = $forEachListVariable1680[i];
...
var $forEachListVariable4208 = permissionList;
var $forEachStartVariable4208 = 0;
var $forEachEndVariable4208 = (permissionList || {}).length;
if(Array.isArray($forEachListVariable4208)) {
for (let i = $forEachStartVariable4208; i < $forEachEndVariable4208; i++) {
const item = $forEachListVariable4208[i];
...
var $forEachListVariable7280 = mappingIdList;
var $forEachStartVariable7280 = 0;
var $forEachEndVariable7280 = (mappingIdList || {}).length;
if(Array.isArray($forEachListVariable7280)) {
for (let j = $forEachStartVariable7280; j < $forEachEndVariable7280; j++) {
const item1 = $forEachListVariable7280[j];
...
var $forEachListVariable1557 = permissionList;
var $forEachStartVariable1557 = 0;
var $forEachEndVariable1557 = (permissionList || {}).length;
if(Array.isArray($forEachListVariable1557)) {
for (let i = $forEachStartVariable1557; i < $forEachEndVariable1557; i++) {
const item = $forEachListVariable1557[i];
var $forEachListVariable2633 = this.alreadySelectedResourceIdList;
var $forEachStartVariable2633 = 0;
var $forEachEndVariable2633 = (this.alreadySelectedResourceIdList || {}).length;
if(Array.isArray($forEachListVariable2633)) {
for (let j = $forEachStartVariable2633; j < $forEachEndVariable2633; j++) {
const item1 = $forEachListVariable2633[j];
...
var $forEachListVariable1478 = variable2;
var $forEachStartVariable1478 = 0;
var $forEachEndVariable1478 = (variable2 || {}).length;
if(Array.isArray($forEachListVariable1478)) {
for (let i = $forEachStartVariable1478; i < $forEachEndVariable1478; i++) {
const item = $forEachListVariable1478[i];
...
var $forEachListVariable7568 = (result || {}).list;
var $forEachStartVariable7568 = 0;
var $forEachEndVariable7568 = ((result || {}).list || {}).length;
if(Array.isArray($forEachListVariable7568)) {
for (let index = $forEachStartVariable7568; index < $forEachEndVariable7568; index++) {
const item = $forEachListVariable7568[index];
...
},
{
        ...
        async function start() {
            await loadScripts(['//ceph.lcap.hatest.163yun.com/lcap-test-static/packages/u-calendar-table@0.2.5/dist-theme/index.js','//ceph.lcap.hatest.163yun.com/lcap-test-static/packages/lcap-login@1.2.2/dist-theme/index.js']);
            
            var customNames = ['u-calendar-table','lcap-login'];
