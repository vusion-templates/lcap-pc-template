    ...
    dnsAddr: 'http://lq0810.defaulttenant.lcap.hatest.163yun.com',
    hasUserCenter: true,
    hasAuth: true,
    authResourcePaths: [
            ...
            <u-table-view-column ref="uTableViewColumn2">
                <template #cell="current" ref="template4">
                    <u-linear-layout ref="uLinearLayout4" gap="small">
                        <u-text ref="uText2" :text="\$utils['ToString']((((current || {}).item || {}).lCAPUserRoleMapping || {}).userName, 'undefined')"></u-text>
                    </u-linear-layout>
                </template>
...
variable1 = await (this.$logics['app.dataSources.defaultDS.entities.LCAPRole.logics.get']({
                config: {
                    download: false,
                },
                query: {},
...
this.inputRoleBody = await (this.$logics['app.dataSources.defaultDS.entities.LCAPRole.logics.create']({
                config: {
                    download: false,
                },
                query: {},
...
this.rolePermissionBody = await (this.$logics['app.dataSources.defaultDS.entities.LCAPPermission.logics.create']({
                config: {
                    download: false,
                },
                query: {},
...
await (this.$logics['app.dataSources.defaultDS.entities.LCAPUser.logics.update']({
                config: {
                    download: false,
                },
                query: {},
...
await (this.$logics['app.dataSources.defaultDS.entities.LCAPUser.logics.create']({
                config: {
                    download: false,
                },
                query: {},
