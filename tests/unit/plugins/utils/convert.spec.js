...
describe('Convert 函数', () => {
    test('Convert 函数，string 到 DateTime', () => {
        ...
        expect(codewaveUtils.ToString({ typeKey: 'nasl.core.DateTime' },
    ...
    test('Convert 函数，string 到 Date', () => {
        ...
        expect(codewaveUtils.ToString({ typeKey: 'nasl.core.Date' },
    ...
    test('Convert 函数，string 到 Time', () => {
        ...
        expect(codewaveUtils.ToString({ typeKey: 'nasl.core.Time' },
