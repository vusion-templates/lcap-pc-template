...
describe('序列化函数', () => {
    ...
    test('ToString 兼容性测试', () => {
        ...
        expect(codewaveUtils.ToString({ typeKey: 'nasl.core.DateTime' }, cur))
    ...
    test('ToString 时区格式化测试', () => {
        {
            ...
            expect(codewaveUtils.ToString({ typeKey: 'nasl.core.DateTime' }, summerTime1, 'America/New_York'))
                .toBe('2016-03-13 03:00:01');
            expect(codewaveUtils.ToString({ typeKey: 'nasl.core.DateTime' }, summerTime1, 'Asia/Shanghai'))
                .toBe('2016-03-13 15:00:01');
        }

        {
            const noSummerTime1 = new Date('2016-03-13T06:59:59Z');
            expect(codewaveUtils.ToString({ typeKey: 'nasl.core.DateTime' }, noSummerTime1, 'America/New_York'))
                .toBe('2016-03-13 01:59:59');
            expect(codewaveUtils.ToString({ typeKey: 'nasl.core.DateTime' }, noSummerTime1, 'Asia/Shanghai'))
