...
describe('序列化函数', () => {
    test('JSON 序列化兼容性测试，无时区', () => {
        const cur = new Date('2023-09-21T09:01:56Z');
        // 零时区的现有展示方式
        expect(codewaveUtils.JsonSerialize(cur, 'UTC')).toBe('"2023-09-21T09:01:56Z"');
        // 未来，想用 "+00:00" 展示零时区
        expect(codewaveUtils.JsonSerialize(cur, 'Etc/GMT')).toBe('"2023-09-21T09:01:56+00:00"');
    });
